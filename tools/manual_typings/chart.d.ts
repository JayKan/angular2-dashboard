...
interface BubbleInstance extends ChartInstance {
  update: () => void;
  getRadius: () => number;
  setHoverStyle: (point: any) => void;
  addElementAndReset: (index: number) => any;
}
...
interface BubbleChartOptions extends ChartOptions {
...
interface Chart extends Base {
  ...
  Bubble(data: BubbleChartData, options?: BubbleChartOptions): BubbleInstance
